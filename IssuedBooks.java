...
public class IssuedBooks extends javax.swing.JFrame {
    ...
    ResultSet rs;
    String query;
    String BId,Bname,SId,Sname,avi,date;
    
    public void viewData(JTable table) {
         try{      
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Id", "Student Name", "Book Id", "Book Name", "Available", "Issue Date"
            }
        ));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     IssuedBooks ibk=new IssuedBooks();
       ibk.viewData(table);        // TODO add your handling code here:
